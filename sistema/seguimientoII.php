...
<div id="tbl-control" class="div-table">
    <h5>Seguimiento II</h5>
    <div class="btns">
    </div>
    <?php if($_SESSION['tblseguimientosG']==1){echo'
    <!-- Tabla del seguimiento I para admin-->
    <table id="tblcontrolseguimientoII" class="display table-bordered table-collapsed" style="width:100%">
        <thead>
            <tr>
                <th>#</th>
                <th>Asignatura</th>
    ...
    <table id="tblSeguimientoII" class="display table-bordered table-collapsed" style="width:100%">
        <thead>
            <tr>
                <th>#</th>
                <th>Asignatura</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h1 class="modal-title fs-5  w-100" id="exampleModalLabel">Seguimiento II</h1>
            </div>
            <div class="modal-body">
                    <div class="mb-3">
                        <input type="text" class="form-control" placeholder="Asignatura" id="id" name="id" hidden>
                        <input type="text" class="form-control" value="Seguimiento II" id="seguimientoII" name="seguimientoII" hidden>
...
<form method="post" id="editarseguimientoII">
<div class="modal fade" id="ModalSeguimientoII" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h1 class="modal-title fs-5  w-100" id="exampleModalLabel">Registro | Seguimiento II</h1>
...
<script type="text/javascript" src="scripts/seguimiento2.js"></script>
