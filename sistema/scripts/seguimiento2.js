let table = new DataTable('#tblcontrolseguimientoII', {
    // config options...
    "lengthMenu": [ 5, 10, 25, 75, 100],//mostramos el menú de registros a revisar
    "ajax": {
      url: "../ajax/seguimientoII.php?op=mostrarSeguimientoII",
      type: "get",
      dataType: "json",
      error: function (e) {
...
//tabla para docentes
let tableI = new DataTable('#tblSeguimientoII', {
    // config options...
    "lengthMenu": [ 5, 10, 25, 75, 100],//mostramos el menú de registros a revisar
    "ajax": {
      url: "../ajax/seguimientoII.php?op=listarIIEsp",
      type: "get",
      dataType: "json",
      error: function (e) {
        console.log(e.responseText);
...
//visualización de datos del seguimiento II en el modal
$("#ModalSeguimientoII").on("show.bs.modal", function (event) {
...
//Codigo para edicion del seguimiento II
$("#editarseguimientoII").submit(function( event ) {
  ...
  var parametros = $(this).serialize();
   ...
   function activar(idControl){
    alertify.confirm('SEGUIMIENTO II','¿Estás Seguro de Activar?', function(){ 
  ...
  function desactivar(idControl){
    alertify.confirm('SEGUIMIENTO II','¿Estás Seguro de Desactivar?', function(){ 
      $.post("../ajax/seguimientoI.php?op=desactivarBtnEditar", { idControl : idControl }, function(e){
      table.ajax.reload();
    tableI.ajax.reload();
