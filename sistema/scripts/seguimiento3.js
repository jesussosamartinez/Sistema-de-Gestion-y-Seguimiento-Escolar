let table3 = new DataTable('#tblcontrolseguimientoIII', {
    // config options...
    "lengthMenu": [ 5, 10, 25, 75, 100],//mostramos el menú de registros a revisar
    "ajax": {
      url: "../ajax/seguimientoII.php?op=SeguimientoIII",
      type: "get",
      dataType: "json",
      error: function (e) {
...
//tabla para docentes
let tableIII = new DataTable('#tblSeguimientoIII', {
    // config options...
    "lengthMenu": [ 5, 10, 25, 75, 100],//mostramos el menú de registros a revisar
    "ajax": {
      url: "../ajax/seguimientoII.php?op=listarIIIEsp",
      type: "get",
      dataType: "json",
      error: function (e) {
        console.log(e.responseText);
...
$("#ModalEditarSeguimientoIII").on("show.bs.modal", function (event) {
  ...
  $("#editarseguimientoIII").submit(function( event ) {
		...
		var parametros = $(this).serialize();
			$.ajax({
				   ...
				   alertify.alert('SEGUIMIENTO III',datos, function(){ 
					   table3.ajax.reload();
             tableIII.ajax.reload();
								});
