...
<div id="tbl-control" class="div-table">
    ...
    <table id="tblcontrolseguimientoIV" class="display table-bordered table-collapsed" style="width:100%">
        <thead>
            <tr>
                <th>#</th>
                <th>Asignatura</th>
    ...
    <table id="tblSeguimientoIV" class="display table-bordered table-collapsed" style="width:100%">
        <thead>
            <tr>
                <th>#</th>
                <th>Asignatura</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h1 class="modal-title fs-5  w-100" id="exampleModalLabel">Evaluación Final</h1>
            </div>
            <div class="modal-body">
                    <div class="mb-3">
                        <input type="text" class="form-control" placeholder="Asignatura" id="id" name="id" hidden>
                        <input type="text" class="form-control" value="Seguimiento Evaluación Final" id="seguimientoIV" name="seguimientoIV" hidden>
...
<form method="post" id="editarseguimientoIV">
<div class="modal fade" id="ModalEditarSeguimientoIV" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h1 class="modal-title fs-5  w-100" id="exampleModalLabel">Registro | Evaluación Final</h1>
...
<script type="text/javascript" src="scripts/evaluacionfinal.js"></script>
